...
void preOrder1(employee_node *root)
{
	if(root!=NULL)
	{
		printf("%s ",root->name);
		preOrder1(root->reportee1);
		preOrder1(root->reportee2);
	}
}
...
void LCBoss(employee_node *root,employee_node *employee1,employee_node *employee2)
{
	...
	i=l-1;
	while(strcmp(boss1->name,boss2->name) != 0)
	{
		findBoss(root,boss1,i);
		boss1=Boss;
		findBoss(root,boss2,i);
		boss2=Boss;
		i--;
	}
	printf(" %s",boss1->name);
...
void Inorder1(employee_node *root)
{
	if(root!=NULL)
	{
		Inorder1(root->reportee1);
		printf("%s ",root->name);
		Inorder1(root->reportee2);
	}
}
		...
		switch(choice)
		{
			...
			case 2:
				...
				printf("\n-----------------------");
					...
					printf("\nemployee_tree");
					printf("\nInoder:");
					Inorder1(employee_tree);
					printf("\nPreorder:");
					preOrder1(employee_tree);
				break;
			case 3:
				printf("\nEnter level : ");
				scanf("%d",&level);
